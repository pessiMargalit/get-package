...
namespace WebAPI.Controllers
{
    ...
    public class DriverController : ControllerBase
    {
        ...
        public async Task<DriverDTO> GetDriverByUserNameAndPasswordAsync(string userName, string password)
        {
            try
            {
                return await driverServiceBL.GetByUserNameAndPasswordAsync(userName, password);
            }
            catch (ArgumentNullException ex) { throw ex; }
            catch (TimeoutException ex) { throw ex; }
            catch (Exception) { throw; }
        ...
        public async Task<bool> DeleteDriver(string username, string password)
        {
            try
            {
                return await driverServiceBL.DeleteAsync(username, password);
            }
            catch (ArgumentNullException ex) { throw ex; }
            catch (TimeoutException ex) { throw ex; }
            catch (Exception) { throw; }
